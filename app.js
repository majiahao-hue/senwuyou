...
<div class="channel-grid reveal" style="max-width:var(--max-w);margin:20px auto;padding:0 clamp(20px,4vw,48px)">
  ...
  <a class="channel-card" href="https://mobile.yangkeduo.com/mall_page.html?mall_id=森无忧" target="_blank" rel="noopener"><div class="ch-icon"><img src="images/icon-pdd.png" alt="拼多多" class="brand-img" width="68" height="68"></div><h3>拼多多旗舰店</h3><p>森无忧拼多多官方旗舰店，人人买得起的好产品。</p><span class="ch-link">进入店铺 →</span></div>
