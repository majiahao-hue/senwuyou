...
<div class="channel-grid reveal" style="max-width:var(--max-w);margin:20px auto;padding:0 clamp(20px,4vw,48px)">
  <a class="channel-card" href="https://mall.jd.com/index-森无忧.html" target="_blank" rel="noopener"><div class="ch-icon"><span class="brand-icon jd"><svg viewBox="0 0 64 64" width="64" height="64"><rect width="64" height="64" rx="16" fill="#e1251b"/><text x="32" y="38" text-anchor="middle" fill="#fff" font-size="24" font-weight="800" font-family="Arial, sans-serif">JD</text></svg></span></div><h3>京东旗舰店</h3><p>森无忧京东官方旗舰店，正品直营，快速配送。点击进入选购全品类产品。</p><span class="ch-link">进入店铺 →</span></a>
  <a class="channel-card" href="https://森无忧.taobao.com" target="_blank" rel="noopener"><div class="ch-icon"><span class="brand-icon tb"><svg viewBox="0 0 64 64" width="64" height="64"><rect width="64" height="64" rx="16" fill="#ff5000"/><circle cx="17" cy="16" r="5" fill="#ffea00"/><text x="32" y="40" text-anchor="middle" fill="#fff" font-size="30" font-weight="800" font-family="PingFang SC, Microsoft YaHei, sans-serif">淘</text></svg></span></div><h3>淘宝旗舰店</h3><p>森无忧淘宝官方旗舰店，优惠活动丰富，购物更便捷。</p><span class="ch-link">进入店铺 →</span></a>
  <a class="channel-card" href="https://mobile.yangkeduo.com/mall_page.html?mall_id=森无忧" target="_blank" rel="noopener"><div class="ch-icon"><span class="brand-icon pdd"><svg viewBox="0 0 64 64" width="64" height="64"><rect width="64" height="64" rx="16" fill="#e22e1f"/><path d="M32 46 C32 46 14 33 14 22 C14 17 18 13 23 13 C27 13 30 16 32 19 C34 16 37 13 41 13 C46 13 50 17 50 22 C50 33 32 46 32 46Z" fill="#fff" opacity="0.22"/><text x="32" y="38" text-anchor="middle" fill="#fff" font-size="22" font-weight="800" font-family="PingFang SC, Microsoft YaHei, sans-serif">拼</text></svg></span></div><h3>拼多多旗舰店</h3><p>森无忧拼多多官方旗舰店，人人买得起的好产品。</p><span class="ch-link">进入店铺 →</span></div>
